...
public final class BinarySearchTree<E extends Comparable<E>>  {
    ...
    protected static int compare = 0;
    ...
    public static boolean searchstring(String e,BinarySearchTree<String> Tree) {
        ...
        while (current != null) {
            ...
            } else if (e.equals(current.element))  // element matches current.element
    ...
    public void inorderl(TreeNode<E> root, ArrayList<E> list) {
        if (root == null) {
            return;
        }
        inorder(root.left);
    ...
    private int getNumberOfLeaves(TreeNode<E> e) {
        if (e == null) {
            return 0;
        }
